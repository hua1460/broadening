function [lamda, y] = dogaussian_nm2nm(lamda0, y0,  Gamma, lamda1, lamda2, Npoints)
%function [lamda, y] = dogaussian_nm2nm(lamda0, y0,  Gamma, lamda1, lamda2, Npoints)
%           |    |                      |   |       |    |       | 
%           nm  arb.unit                nm  arb.unit eV   nm      nm
% DO GAUSSIAN CONVOLUTION for bar data in eV and change into data in nm
% (FOR, e.g., UV ABSORPTION SPECTRUM) 
% 
% THE INPUT SETS [lamda0 y0] are the raw "wave length(nm)"-"oscillator strength" data
...
% NOTE: The difference between dogaussian and dogaussian_nm2nm lies in that
...
% lamda0 in unit of nm,  x0 is in unit of eV
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%        
x =  constant2./lamda;  
...
% calculate f
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Gaussian y at the sample point
